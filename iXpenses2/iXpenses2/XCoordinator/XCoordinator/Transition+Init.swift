...
extension Transition {
    ...
    ///
    public static func presentOnRoot(_ presentable: Presentable, animation: XCoordinatorAnimation? = nil) -> Transition {
    ...
    ///         the default UIKit animations.
    ///
    public static func present(_ presentable: Presentable, animation: XCoordinatorAnimation? = nil) -> Transition {
        Transition(presentables: [presentable],
                   animationInUse: animation?.presentationAnimation
        ) { rootViewController, options, completion in
    ...
    ///
    public static func dismissToRoot(animation: XCoordinatorAnimation? = nil) -> Transition {
    ...
    ///     default UIKit animations.
    ///
    public static func dismiss(animation: XCoordinatorAnimation? = nil) -> Transition {
        Transition(presentables: [],
                   animationInUse: animation?.dismissalAnimation
        ) { rootViewController, options, completion in
