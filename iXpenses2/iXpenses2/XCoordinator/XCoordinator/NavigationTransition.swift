...
extension Transition where RootViewController: UINavigationController {
    ...
    ///         on this presentable.
    ///
    public static func push(_ presentable: Presentable, animation: XCoordinatorAnimation? = nil) -> Transition {
    ...
    ///     on this presentable.
    ///
    public static func pop(animation: XCoordinatorAnimation? = nil) -> Transition {
    ...
    ///         on this presentable.
    ///
    public static func pop(to presentable: Presentable, animation: XCoordinatorAnimation? = nil) -> Transition {
        Transition(presentables: [presentable],
                   animationInUse: animation?.dismissalAnimation
        ) { rootViewController, options, completion in
    ...
    ///     on this presentable.
    ///
    public static func popToRoot(animation: XCoordinatorAnimation? = nil) -> Transition {
        Transition(presentables: [],
                   animationInUse: animation?.dismissalAnimation
        ) { rootViewController, options, completion in
    ...
    ///
    public static func set(_ presentables: [Presentable], animation: XCoordinatorAnimation? = nil) -> Transition {
