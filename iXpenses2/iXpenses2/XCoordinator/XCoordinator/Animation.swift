...
///
open class XCoordinatorAnimation: NSObject {
    ...
    ///
    public static let `default` = XCoordinatorAnimation(presentation: nil, dismissal: nil)
...
extension XCoordinatorAnimation: UIViewControllerTransitioningDelegate {
