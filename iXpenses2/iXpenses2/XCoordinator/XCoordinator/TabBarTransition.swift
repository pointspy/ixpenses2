...
extension Transition where RootViewController: UITabBarController {
    ...
    ///         The animation to be used. If you specify `nil` here, the default animation by UIKit is used.
    ///
    public static func select(_ presentable: Presentable, animation: XCoordinatorAnimation? = nil) -> Transition {
    ...
    ///         The animation to be used. If you specify `nil` here, the default animation by UIKit is used.
    ///
    public static func select(index: Int, animation: XCoordinatorAnimation? = nil) -> Transition {
